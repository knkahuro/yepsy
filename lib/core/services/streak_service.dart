...
import 'package:yepsy/features/tasks/services/task_service.dart';
...
class StreakService {
  ...
  /// Checks if there is any activity (note, task, symptom, or sleep log) on a specific day.
  Future<bool> _hasActivityOnDate(DateTime date) async {
    ...
    if (tasks.any((m) => _isSameDay(m.date, date))) return true;
